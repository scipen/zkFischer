...
contract zkFischer {
    ...
    function move(
        ...
        if (piece != 9 && piece != 19) {
            ...
            uint _pieceFile = input[1]*4 + input[2]*2 + input[3] + 1;  // bin2dec, plus 1 for bytecode reduc
